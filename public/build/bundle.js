...
var app = (function () {
    ...
    // (22:4) {#each repos as repo, i}
    function create_each_block(ctx) {
    	let h1;
    	let t0_value = /*repo*/ ctx[5].name + "";
    	let t0;
    	let t1;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(22:4) {#each repos as repo, i}",
    		ctx
    	});
    ...
    // (19:16)      <p>Fetching Repos ....</p> {:then repos}
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(19:16)      <p>Fetching Repos ....</p> {:then repos}",
    		ctx
    	});
